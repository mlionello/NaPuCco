function [nvox, clbc_n_range, mvox, clbc_m_range] = check_clusterbased_padding( ...
    ...
    % If I have less voxels than the ones required in the range, then reduce the
    % range
    ...
    % If I have more voxels than the ones required in the range, then reduce the
    ...
    % If I have less null voxels than the ones required in the range, then reduce the
    ...
    % If I have more null voxels than the ones required in the range, then reduce the
